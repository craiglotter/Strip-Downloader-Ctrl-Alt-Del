...
Public Class Main_Screen
            ...
            If BackgroundWorker1.CancellationPending = False Then
                ...
                While currentdate <= DateTimePicker2.Value
                    If BackgroundWorker1.CancellationPending = False Then
                        ...
                        addrs.Add("http://www.ctrlaltdel-online.com/comics/" & Format(currentdate, "yyyyMMdd") & ".gif")
                        addrs.Add("http://www.ctrlaltdel-online.com/comics/" & Format(currentdate, "yyyyMMdd") & ".jpg")
                        For Each address As String In addrs
                            Try
                                ...
                                'WbReq.DownloadFile(New Uri(address), (Setting_StripsFolder.Text & "\" & address.Remove(0, address.LastIndexOf("/"))).Replace("/", "\").Replace("\\", "\"))
                                'WbReq.Dispose()
                            ...
                            Catch ex As System.Net.WebException
                                'Error_Handler(ex, "Downloading: " & address)
                            Catch ex As Exception
                                Error_Handler(ex, "Downloading: " & address)
                            End Try
                        Next
    ...
    Private Sub ProxyToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ProxyToolStripMenuItem.Click
        Try
